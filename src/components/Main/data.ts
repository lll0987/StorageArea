export const boxes = [
    ...
    { id: 'HCW', width: 9, height: 7, depth: 24, color: 'skyblue' },
    { id: 'HSP', width: 16, height: 8, depth: 23, color: 'darkseagreen' },
        ...
        segments: [
            ...
            },
            {
                ...
                locations: [
                    ...
                    { pk: 4, verticalPK: 0, horizontalPK: 3, frontPK: 0 },
                    { pk: 5, verticalPK: 0, horizontalPK: 4, frontPK: 0, box: 'HCW' },
                    { pk: 6, verticalPK: 5, horizontalPK: 4, frontPK: 0, box: 'HCW' },
                    { pk: 7, verticalPK: 0, horizontalPK: 5, frontPK: 0, box: 'HBX' },
                    { pk: 8, verticalPK: 0, horizontalPK: 7, frontPK: 0, box: 'HZDL' }
                ]
            },
            {
                height: 2,
                ...
                locations: [
                    ...
                    { pk: 2, verticalPK: 0, horizontalPK: 1, frontPK: 0, box: 'HSP' },
                    { pk: 3, verticalPK: 2, horizontalPK: 1, frontPK: 0, box: 'HSP' },
                    { pk: 4, verticalPK: 0, horizontalPK: 2, frontPK: 0, box: 'WL' },
                    { pk: 5, verticalPK: 0, horizontalPK: 4, frontPK: 0, box: 'HZDM' }
                ]
            }
        ]
    }
